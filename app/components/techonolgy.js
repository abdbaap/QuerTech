...
export default function MotivationBlog() {
  return (<div id='motivation' className="flex flex-col justify-center items-center gap-8 text-center h-[150%] overflow-x-hidden  ">
    ...
    <div className="flex flex-wrap gap-16 overflow-y scroll max-h-200vh px-10 xl:px-auto snap-mandatory snap-x items-center">
