...
export default function Herosection() {
  return (
    <div id="https://quertech-articles.vercel.app/" className="herosection text-white w-full gap-32 bg-black justify-center items-center flex flex-col text-center xl:p-16 p-2">
