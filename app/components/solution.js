...
{SolutionBlogs.map((item,index) => { return(
    <Link target='_blank' href={`https://quertech-articles.vercel.app/${item.link}/index.html`} key={index} className="flex hover:tracking-wider transition-all duration-500 flex-col bg-gray-950 text-white justify-center xl:w-80 w-75 h-100 rounded-xl items-center p-8 gap-2">
