  ...
  return (
    <div id='courses' className="flex p-8 flex-col w-full justify-center items-center gap-8  text-center ">
        ...
        <div className="flex flex-wrap w-full justify-evenly text-black items-center gap-16">
            {courses.map((item,I) => { 
             return   <Link target='_blank' href={`/${item.link}/index.html`} key={I} className="flex flex-row justify-evenly m-0   items-center  rounded-xl w-80 h-100 bg-gray-400 shadow-sm hover:shadow-2xl gap-2">
