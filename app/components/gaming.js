...
export default function GamingBlog() {
  return (
    <div id='gaming' className="flex w-full text-center  flex-col justify-center items-center bg-linear-to-r from-orange-500 via-pink-500 to-purple-600 animate-gradient gap-8 xl:p-32 ">
