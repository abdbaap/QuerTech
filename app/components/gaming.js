...
{GamingBlogs.map((item,index) => { 
  return (
    <Link target='_blank' href={`/${item.link}/index.html`} key={index} className="flex flex-none text-white  justify-between snap-center items-center w-75 xl:w-110 h-110 shrink-0">
