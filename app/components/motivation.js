...
{MotivationBlogs.map((item,index) => { 
    return (<div key={index} className="motivationcard flex noscrollbar  text-black gap-2  justify-evenly bg-gray-400 rounded-xl shadow-sm hover:shadow-2xl p-1 w-80 h-110 snap-center items-center text-center shrink-0">
